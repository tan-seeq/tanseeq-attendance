...
```bash
# اختبار endpoint
curl -X GET "https://attendance-pro-43.preview.emergentagent.com/api/payroll/cycles" \
...
curl -X POST "https://attendance-pro-43.preview.emergentagent.com/api/deductions/apply-monthly" \
  -H "Authorization: Bearer {token}" \
