...
```bash
# اختبار endpoint
curl -X GET "https://salary-processor-1.preview.emergentagent.com/api/payroll/cycles" \
...
curl -X POST "https://salary-processor-1.preview.emergentagent.com/api/deductions/apply-monthly" \
  -H "Authorization: Bearer {token}" \
