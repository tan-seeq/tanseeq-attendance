...
```bash
# اختبار endpoint
curl -X GET "https://payroll-management-4.preview.emergentagent.com/api/payroll/cycles" \
...
curl -X POST "https://payroll-management-4.preview.emergentagent.com/api/deductions/apply-monthly" \
  -H "Authorization: Bearer {token}" \
