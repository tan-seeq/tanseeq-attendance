...
```bash
# اختبار endpoint
curl -X GET "https://tanseeq-payroll-1.preview.emergentagent.com/api/payroll/cycles" \
...
curl -X POST "https://tanseeq-payroll-1.preview.emergentagent.com/api/deductions/apply-monthly" \
  -H "Authorization: Bearer {token}" \
