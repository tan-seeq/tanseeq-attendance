...
```bash
# اختبار endpoint
curl -X GET "https://hr-unification.preview.emergentagent.com/api/payroll/cycles" \
...
curl -X POST "https://hr-unification.preview.emergentagent.com/api/deductions/apply-monthly" \
  -H "Authorization: Bearer {token}" \
