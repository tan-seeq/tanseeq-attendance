...
```bash
# اختبار endpoint
curl -X GET "https://payroll-hardening.preview.emergentagent.com/api/payroll/cycles" \
...
curl -X POST "https://payroll-hardening.preview.emergentagent.com/api/deductions/apply-monthly" \
  -H "Authorization: Bearer {token}" \
