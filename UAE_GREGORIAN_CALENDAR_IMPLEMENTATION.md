...
```bash
# اختبار endpoint
curl -X GET "https://attend-deduct-hr.preview.emergentagent.com/api/payroll/cycles" \
...
curl -X POST "https://attend-deduct-hr.preview.emergentagent.com/api/deductions/apply-monthly" \
  -H "Authorization: Bearer {token}" \
