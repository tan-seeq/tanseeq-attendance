...
```bash
# اختبار endpoint
curl -X GET "https://tanseeq-hr-fix.preview.emergentagent.com/api/payroll/cycles" \
...
curl -X POST "https://tanseeq-hr-fix.preview.emergentagent.com/api/deductions/apply-monthly" \
  -H "Authorization: Bearer {token}" \
